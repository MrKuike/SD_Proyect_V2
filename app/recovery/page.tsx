...
export default function Recovery() {
  ...
  function requestPasswordReset() {
    ...
    fetch('http://localhost:3002/api/request-reset', {
      method: 'POST',
      headers: myHeaders,
      body: raw,
      redirect: 'follow',
  ...
  function changePassword() {
    ...
    fetch('http://localhost:3002/api/reset', {
      method: 'POST',
      headers: myHeaders,
      body: raw,
      redirect: 'follow',
        ...
        <div className='mt-10 card sm:mx-auto sm:w-full sm:max-w-sm'>
          ...
          {!passwordRecovered ? (
                ...
                <div className='space-y-6'>
                  ...
                  <div>
                    <button
                      ...
                      className='flex w-full justify-center btn-primary rounded-md px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
                    >
            ...
            <Link href='/login'>
              <button
                type='submit'
                className='flex w-full justify-center rounded-md  px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm btn-primary hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
              >
                Volver al Login
              </button>
            </Link>
